        ...
        {bookmarks.map(bookmark => (
          <div
            ...
            className={`group relative rounded-lg p-3 ${
              isDarkMode ? 'bg-black hover:bg-black' : 'bg-white hover:bg-sky-50'
              ...
              <div className="flex items-center">
                <input
                  ...
                  className={`mr-2 grow rounded px-2 py-1 text-sm ${
                    isDarkMode ? 'border-slate-600 bg-black text-gray-200' : 'border-sky-100 bg-white text-gray-700'
                  } border`}
                />
                <button
                  onClick={() => handleSaveEdit(bookmark.id)}
                  className={`rounded p-1 ${
                    isDarkMode ? 'bg-black text-green-400 hover:bg-black' : 'bg-white text-green-500 hover:bg-gray-100'
                  }`}
                ...
                <button
                  ...
                  className={`ml-1 rounded p-1 ${
                    isDarkMode ? 'bg-black text-red-400 hover:bg-black' : 'bg-white text-red-500 hover:bg-gray-100'
                  }`}
